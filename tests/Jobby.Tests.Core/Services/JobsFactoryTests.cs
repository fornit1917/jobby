...
{
    private const string CRON_SIMPLE_SCHEDULER_TYPE = "CRON_SIMPLE";
    ...
    public void CreateRecurrent_OptionsNotSpecified_CreatesJobModelWithDefaultOptions()
    {
        ...
        Assert.Equal(CRON_SIMPLE_SCHEDULER_TYPE, job.SchedulerType);
    ...
    private JobsFactory GetFactory(string? defaultRecurrentQueue = null, SchedulersRegistry? schedulers = null)
    {
        var builder = new SchedulersRegistry.Builder();
